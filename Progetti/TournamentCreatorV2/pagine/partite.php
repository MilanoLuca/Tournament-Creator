        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
                <div class="fadeIn first">
                    ...
                    $query = "SELECT IDPartita FROM partita, torneo WHERE torneo.IDTorneo = " . $_SESSION["idTorneo"];
                    ...
                    if (mysqli_num_rows($result) = 0) {
                        ...
                        $query = "SELECT IDSquadra, Nome FROM squadra, torneo WHERE torneo.IDTorneo = " . $_SESSION["idTorneo"];
                        echo "<br>Partite<br><br>";
                        $result = mysqli_query($connesione, $query)
                                or die("query sbagliata");
